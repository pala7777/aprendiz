...
window.PLATFORM = {
  ...
  courses: [
    ...
    { id:"rua", cat:"corrida", published:false,
      ...
      img:"assets/img/m3.jpg", level:"Iniciante+", dur:"em breve",
    ...
    { id:"forca-endurance", cat:"forca", published:false,
      ...
      img:"assets/img/m2.jpg", level:"Todos os níveis", dur:"em breve",
    ...
    { id:"longevidade", cat:"forca", published:false,
      ...
      img:"assets/img/m1.jpg", level:"40+", dur:"em breve",
    ...
    { id:"fisiologia", cat:"metodologia", published:false,
      ...
      img:"assets/img/m0.jpg", level:"Intermediário", dur:"em breve",
    ...
    { id:"periodizacao", cat:"metodologia", published:false,
      ...
      img:"assets/img/m5.jpg", level:"Treinadores", dur:"em breve",
    ...
    { id:"nutricao", cat:"nutricao", published:false,
      ...
      img:"assets/img/m4.jpg", level:"Todos os níveis", dur:"em breve",
    ...
    { id:"ciclismo", cat:"ciclismo", published:false,
      ...
      img:"assets/img/m2.jpg", level:"Intermediário", dur:"em breve",
    ...
    { id:"triatlo", cat:"ciclismo", published:false,
      ...
      img:"assets/img/hero.jpg", level:"Intermediário+", dur:"em breve",
